...
export const translations = {
  ...
  'cc-addon-backups.description.postgresql-addon': `Les sauvegardes sont réalisées en utilisant l'outil pg_dump.`,
  'cc-addon-backups.description.mysql-addon': `Les sauvegardes sont réalisées en utilisant l'outil mysqldump.`,
  'cc-addon-backups.description.mongodb-addon': `Les sauvegardes sont réalisées en utilisant l'outil mongodump.`,
  ...
  'cc-addon-backups.restore.manual.description.postgresql-addon': `Vous pouvez restaurer cette sauvegarde manuellement grâce à l'outil pg_restore en exécutant cette commande :`,
  'cc-addon-backups.restore.manual.description.mysql-addon': `Vous pouvez restaurer cette sauvegarde manuellement grâce à la CLI mysql en exécutant cette commande :`,
  'cc-addon-backups.restore.manual.description.mongodb-addon': `Vous pouvez restaurer cette sauvegarde manuellement grâce à l'outil mongorestore en exécutant cette commande :`,
