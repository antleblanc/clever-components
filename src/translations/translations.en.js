...
export const translations = {
  ...
  'cc-addon-backups.description.postgresql-addon': `Backups are created using the pg_dump tool.`,
  'cc-addon-backups.description.mysql-addon': `Backups are created using the mysqldump tool.`,
  'cc-addon-backups.description.mongodb-addon': `Backups are created using the mongodump tool.`,
  ...
  'cc-addon-backups.restore.manual.description.postgresql-addon': `You can restore this backup using the pg_restore tool by executing this command:`,
  'cc-addon-backups.restore.manual.description.mysql-addon': `You can restore this backup using the mysql CLI by executing this command:`,
  'cc-addon-backups.restore.manual.description.mongodb-addon': `You can restore this backup using the mongorestore tool by executing this command:`,
